...
public class Inventory {
    ...
    // Check if the inventory contains a pickup of chosen type
    public boolean contains(Pickup pickup){
        for(Pickup p : inventoryList){
            if(pickup.getClass().equals(p.getClass())){
                return true;
            }
        }
        return false;
